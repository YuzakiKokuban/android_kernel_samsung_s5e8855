...
# Kokuban 内核 for 三星 Galaxy Tab S10 FE 系列
...
<p align="center">
<a href="https://github.com/YuzakiKokuban/android_kernel_samsung_s5e8855/releases"><img src="https://img.shields.io/github/v/release/YuzakiKokuban/android_kernel_samsung_sm8750?style=for-the-badge&logo=github&color=blue" alt="GitHub release"></a>
...
这是一个基于三星官方内核源码构建的，适用于 **三星 Galaxy Tab S10 FE 系列** 的高性能自定义内核。它旨在提供卓越的稳定性和流畅度，同时集成了最新的 KernelSU 功能，为您带来最佳的玩机体验。
...
* **版本信息**: `-android15-Kokuban-Rappa-AYG5`
...
所有最新版本都可以在 [**Releases 页面**](https://github.com/YuzakiKokuban/android_kernel_samsung_s5e8855/releases) 找到。
...
# Kokuban Kernel for Samsung Galaxy Tab S10 FE Series
...
This is a high-performance custom kernel for the **Samsung Galaxy Tab S10 FE Series**, built upon Samsung's official kernel source. It is designed to deliver exceptional stability and smoothness while integrating the latest KernelSU features for the ultimate user experience.
...
* **Version Info**: `-android15-Kokuban-Rappa-AYG5`
...
All the latest builds can be found on the [**Releases Page**](https://github.com/YuzakiKokuban/android_kernel_samsung_s5e8855/releases).
